 ...
 * 展示可选的营销业务目标，支持用户选择
 */
const GoalSelector = ({ goals, loading, onSelect }) => {
  if (loading) {
    return (
      <div className="loading-container">
        <Spin size="large" />
        <div className="loading-text">加载营销目标...</div>
      </div>
    );
  }
  ...
  return (
    <div className="goal-selector">
      <Title level={4}>选择您的营销目标</Title>
      <Paragraph type="secondary">
        选择一个营销业务目标，系统将根据目标自动推荐客群、生成营销内容并优化渠道配置
      </Paragraph>
